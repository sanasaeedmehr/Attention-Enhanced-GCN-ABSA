...
from models import LSTM, LSTM_ASPECT, Bi_LSTM, Bi_LSTM_ASPECT, CNN, CNN_ASPECT, Bi_LSTM_CNN, Bi_LSTM_CNN_ASPECT, GCN, GCN_ASPECT, Bi_LSTM_GCN, Bi_LSTM_GCN_ASPECT, GCN_ATTENTION
...
if __name__ == '__main__':
    ...
    model_classes = {
        'lstm': LSTM,
        'lstm_aspect': LSTM_ASPECT,
        'bi_lstm': Bi_LSTM,
        'bi_lstm_aspect': Bi_LSTM_ASPECT,
        'cnn': CNN,
        'cnn_aspect': CNN_ASPECT,
        'bi_lstm_cnn': Bi_LSTM_CNN,
        'bi_lstm_cnn_aspect': Bi_LSTM_CNN_ASPECT,
        'gcn': GCN,
        'gcn_aspect': GCN_ASPECT,
        'bi_lstm_gcn': Bi_LSTM_GCN,
        'bi_lstm_gcn_aspect': Bi_LSTM_GCN_ASPECT,
        'gcn_attention': GCN_ATTENTION,
    }
    input_colses = {
        'lstm': ['text_indices'],
        'lstm_aspect': ['text_indices', 'aspect_indices'],
        'bi_lstm': ['text_indices'],
        'bi_lstm_aspect': ['text_indices', 'aspect_indices'],
        'cnn': ['text_indices'],
        'cnn_aspect': ['text_indices', 'aspect_indices'],
        'bi_lstm_cnn': ['text_indices'],
        'bi_lstm_cnn_aspect': ['text_indices', 'aspect_indices'],
        
        'gcn': ['text_indices', 'dependency_graph'],
        'gcn_aspect': ['text_indices', 'aspect_indices', 'dependency_graph'],
        'bi_lstm_gcn': ['text_indices', 'dependency_graph'],
        'bi_lstm_gcn_aspect': ['text_indices', 'aspect_indices', 'dependency_graph'],
        'gcn_attention': ['text_indices', 'dependency_graph'],
    }
    initializers = {
